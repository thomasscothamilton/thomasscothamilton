...
//+kubebuilder:rbac:groups=resumes.thomasscothamilton.com,resources=resumes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=resumes.thomasscothamilton.com,resources=resumes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=resumes.thomasscothamilton.com,resources=resumes/finalizers,verbs=update
